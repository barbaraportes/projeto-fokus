...
const alterarIconePlay = document.querySelector('.app__card-primary-button-icon');
...
function alterarContexto(contexto) {
    ...
    switch (contexto) {
        ...
        case "descanso-longo":
            titulo.innerHTML= `
            Hora de voltar a superfície.<br> <strong class="app__title-strong"> Faça uma pausa longa. </strong>
            `
            break;
